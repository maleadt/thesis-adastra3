...
Vooraleer dieper in te gaan op hoe we open-source licenties kunnen gebruiken, is het interessant om een grove indeling te maken en zo enkele terugkerende eigenschappen te beschrijven. Hierbij baseren we ons op \makeurl{https://www.gnu.org/philosophy/categories.html}{een beschrijving} van de \ac{fsf}.
...
Hoewel permissive licenties weinig of geen restricties stelden aan het gebruik van de code, blijft het copyright steeds in handen van de originele auteur. Bij public domain licenties is dit niet langer het geval: de auteur geeft al zijn rechten uit handen, waardoor iedereen om het even wat mag doen met de code.

\section{Open-source software commercialiseren}

Hoewel het een speciale aanpak vereist, is het best mogelijk om open-source software te commercialiseren. We beschrijven hier twee mogelijke manieren om dit te doen, elk met een succesvol voorbeeld van een bedrijf die dit gedaan heeft.
