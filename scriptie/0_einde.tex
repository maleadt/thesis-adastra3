...
% Clienthardware
Het toestel om de clientapplicatie op uit te voeren is na lang zoeken de \code{Genesi Efika MX} geworden, een relatief goedkope maar toch krachtige \emph{embedded computer}. Om er eenvoudig software op te kunnen installeren en onderhouden hebben we een Debian besturingssysteem samengesteld waarbij ons eigen pakketen ingeladen worden van een lokaal beheerde repository.
